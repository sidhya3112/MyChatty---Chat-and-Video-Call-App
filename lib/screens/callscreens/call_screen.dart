...
import 'package:my_chatty/configs/agora_configs.dart';
...
class _CallScreenState extends State<CallScreen> {
  ...
  Future<void> _onEnableVideo() {
    setState(() {
      enableVideo = !enableVideo;
    });
    return AgoraRtcEngine.enableLocalVideo(enableVideo);
  }
